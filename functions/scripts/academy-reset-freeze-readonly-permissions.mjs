...
function assertStorageLinkage(registry, operationRegistry) {
  ...
  if (!same(media.requiredIamPermissions, ["storage.objects.get"]) ||
      ...
      !mediaDescriptor || !metadataDescriptor ||
